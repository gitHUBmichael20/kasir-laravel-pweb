...
<body class="bg-white sm:ml-64 p-4 dark:bg-gray-900 min-h-screen flex items-center justify-center">
    @include('components.navbar')

    <section class="py-8 bg-white md:py-16 dark:bg-gray-900 antialiased h-full">
