...
@section('content')
    <div class="bg-white sm:ml-64 p-4 dark:bg-gray-900 min-h-screen">
        {{-- The @include('layout.app') here is likely a mistake if layout.app is your main layout.
             If it's meant to include a sub-component within the main content, ensure it's named differently
            ...
            <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0 w-full">
                <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16 items-center">
                    ...
                    <div
                        ...
                        <form id="storeDataForm" class="max-w-lg mx-auto" action="{{ route('produk.store') }}"
                            ...
                            <button type="submit"
                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition-all duration-200 store-produk-form">
                                Tambah Produk
                            </button>
                        </form>
                    </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                const productImageInput = document.getElementById('foto_produk'); // Changed ID to match name
                ...
                productImageInput.addEventListener('change', (event) => {
                    ...
                    if (file) {
                        ...
                        if (placeholderText) {
                            ...
                            newPlaceholder.textContent = 'Pratinjau Gambar Produk';
