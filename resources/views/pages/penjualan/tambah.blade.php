...
<head>
    ...
    <title>Tambahkan Transaksi</title>
...
<body class="bg-white sm:ml-64 p-4 dark:bg-gray-900">
    ...
    <main class="container mx-auto px-4 py-8 md:py-12 flex">
        {{-- Card Product --}}
            ...
            @foreach ($produks as $produk)
                <div
                    ...
                    <div class="h-56 w-full">
                        <img src="{{ route('produk.gambar', $produk->foto_produk) }}" alt="{{ $produk->NamaProduk }}"
                    ...
                    <div class="pt-6">
                        ...
                        <ul class="mt-2 flex items-center gap-4">
                            <li class="flex items-center gap-2">
                                ...
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ $produk->ProdukID }}
                                </p>
                            </li>
                            ...
                            <li class="flex items-center gap-2">
                                ...
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ $produk->Stok }}</p>
                            </li>
                        </ul>
        ...
        <div id="bill-product" class="container mx-auto px-4 py-8">
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-6">Your Cart Summary</h2>

            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl overflow-hidden mb-8">
                <div class="p-6">
                    <div
