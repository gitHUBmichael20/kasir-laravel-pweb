...
<head>
    ...
    <title>Kasir Laravel 2025</title>
...
<body class="bg-gray-50 dark:bg-gray-900 font-sans antialiased">
    ...
    <main class="sm:ml-64 p-4 md:p-6">
        <!-- Stats Cards -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <!-- Card 1: Total Penjualan -->
            <div class="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md border border-slate-500 card-hover">
                <div class="flex items-center">
                    <div class="p-3 icon-bg rounded-full">
        ...
        <div class="mb-6">
            ...
            <div class="flex flex-wrap gap-4">
                <button class="px-4 py-2 btn-gradient text-white rounded-lg shadow-md hover:shadow-lg">Tambah
                    Transaksi</button>
                <button class="px-4 py-2 btn-gradient text-white rounded-lg shadow-md hover:shadow-lg">Tambah
                    Produk</button>
                <button class="px-4 py-2 btn-gradient text-white rounded-lg shadow-md hover:shadow-lg">Lihat
                    Laporan</button>
            </div>
        </div>
        ...
        <div class="relative overflow-x-auto my-4">
            <table class="mx-auto w-full text-sm text-center rtl:text-right text-gray-500 dark:text-gray-300">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-800 dark:text-gray-200">
                    <tr>
                        <th class="px-3 py-3 w-20 text-xs font-semibold tracking-wider">ID</th>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-700 dark:border-gray-600 border-gray-200">
                            ...
                            <td class="px-6 py-4">
                                <button type="button"
                                    ...
                                    Resi</button>
                                <button type="button"
                                    class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800">Lihat
                                    Detail</button>
                            </td>
                        </tr>
                    @endforeach
